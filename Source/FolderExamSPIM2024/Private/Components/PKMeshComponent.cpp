...
//    UMaterialInterface* DefaultMaterial = ConstructorHelpers::FObjectFinder<UMaterialInterface>(TEXT("/Game/FolderExamSPIM2024/Materials/MM_SphereMaterial.MM_SphereMaterial")).Object;  
//    if (DefaultMaterial)  
//    {  
